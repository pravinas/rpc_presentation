...
\end{block}
\only<2>{\centering\vspace{10px}\animategraphics[loop, width=0.5\textwidth,autoplay]{0.8}{./assets/rrt_gif/rrt_gif-}{0}{30}}
...
\begin{frame}{Example \textsc{sbmp} Execution}
\centering
\only<1>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_2.png}
}\only<2>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_2.5.png}
}\only<3>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_3.png}
}\only<4>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_3.25.png}
}\only<5>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_3.5.png}
}\only<6>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_4.png}
}\only<7>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_5.png}
}\only<8>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_6.png}
}\only<9>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_7.png}
}\only<10>{\includegraphics[width=\textwidth]{./assets/rrt_slides/rrt_slides_8.png}
}

\only<1>{Problem Definition
}\only<2>{Configuration Space
}\only<3>{Sampling
}\only<4>{State Collision Check
}\only<5>{State Validation
}\only<6>{Local Planning
}\only<7>{Edge Collision Check
}\only<8>{Edge Validation
}\only<9>{Generate Graph
}\only<10>{Find Path
}
\end{frame}
...
\textsc{cc} is conventionally thought of as the most computationally intensive step of the motion planning process, taking up to 90\% of planning time. [\cite{paper:rrt90}]%, so much of the discussion is in optimizing \textsc{cc} and \textsc{fk}
...
\begin{itemize}
\pause \item Motion planning parallelism is typically acheived by running several independent planners in parallel. %What the authors refer to as coarse-grained parallelism
...
}\only<1>{\includegraphics[width=0.8\textwidth]{./assets/rrt_slides/rrt_slides_5.png}
}\only<2>{\includegraphics[width=0.8\textwidth]{./assets/rake/rrt_slides_5.png}
...
\only<1>{\includegraphics[width=\textwidth]{./assets/mbm.png}
[\cite{paper:MBM}]}\only<2>{\includegraphics[width=\textwidth]{./assets/cc_nn_zoom.png}
[Ghosal, Sacher, \textbf{Samaratunga}, Neuman, Plancher, Reddi 2024 (in preparation)]
}
\end{frame}
...
\begin{column}{0.5\textwidth}
\centering
\animategraphics[loop,height=0.8\textheight,autoplay]{3}{./assets/waving/waving-}{1}{6}
\end{column}
\end{columns}
\end{frame}
